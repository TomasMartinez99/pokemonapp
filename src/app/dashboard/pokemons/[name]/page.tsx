...
export async function generateMetadata( { params }:Props ): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Excepturi llo consequatur dolorum illum temporibus, ducimus iure fugiat dignissimos voluptas doloremque aspernatur libero'
    }
  }
